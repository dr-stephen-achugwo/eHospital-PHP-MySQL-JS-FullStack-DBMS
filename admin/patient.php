            ...
            <table border="0" width="100%" style=" border-spacing: 0;margin:0;padding:0;margin-top:25px; ">
                <tr >
                    ...
                    <td>
                        ...
                        <form action="" method="post" class="header-search">
                            ...
                            <input type="search" name="search" class="input-text header-searchbar" placeholder="Search Patient by Name | Email" list="patient">&nbsp;&nbsp;
                            
                            <?php
                                echo '<datalist id="patient">';
                                $list11 = $database->query("SELECT patient_name, patient_email FROM ehos_patient;");
                ...
                <?php
                    if($_POST){
                        ...
                        $sqlmain= "SELECT * from ehos_patient where patient_email='$keyword' or patient_name='$keyword' or patient_name like '$keyword%' or patient_name like '%$keyword' or patient_name like '%$keyword%' ";
                    }else{
                        $sqlmain= "SELECT * from ehos_patient order by patient_id desc";
                        ...
                        <table width="80%" class="sub-table scrolldown add-doc-form-container" border="0">
                            ...
                            <tr>
                                ...
                                <td class="label-td" colspan="2">
                                    <label for="name" class="form-label">Patient Number: </label>
                                </td>
                            </tr>
                            <tr>
                                <td class="label-td" colspan="2">
                            ...
                            <tr>
                                <td class="label-td" colspan="2">
                                    <label for="spec" class="form-label">Patient City: </label>

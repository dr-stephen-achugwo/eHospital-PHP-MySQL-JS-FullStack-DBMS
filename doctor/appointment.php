        ...
        <div class="dash-body">
            <table border="0" width="100%" style=" border-spacing: 0;margin:0;padding:0;margin-top:25px; ">
                <tr>
                    ...
                    <td>
                        <p style="font-size: 23px;padding-left:12px;font-weight: 600;">Recorded hours</p>
                    ...
                    <td width="15%">
                        ...
                        $stmt = $database->prepare("SELECT * FROM ehos_schedule INNER JOIN ehos_appointment on ehos_schedule.schedule_id = ehos_appointment.schedule_id 
                ...
                <?php
                    ...
                    $sqlmain= "SELECT ehos_appointment.appointment_id, ehos_schedule.schedule_id, ehos_schedule.title, ehos_doctor.doctor_name, ehos_patient.patient_name, ehos_schedule.schedule_date, ehos_schedule.schedule_time, ehos_appointment.appointment_num 
                    FROM ehos_schedule INNER JOIN ehos_appointment on ehos_schedule.schedule_id = ehos_appointment.schedule_id 
                    INNER JOIN ehos_patient on ehos_patient.patient_id = ehos_appointment.patient_id 
                    INNER JOIN ehos_doctor on ehos_schedule.doctor_id = ehos_doctor.doctor_id  WHERE ehos_doctor.doctor_id = $userid ";
                            ...
                            <?php
                                ...
                                for ( $x=0; $x<$result->num_rows;$x++){
                                    ...
                                    echo '<tr >
                                        ...
                                        <!--<a href="?action=view&id='.$appointment_id.'" class="non-style-link"><button  class="btn-primary-soft btn button-icon btn-view"  style="padding-left: 40px;padding-top: 12px;padding-bottom: 12px;margin-top: 10px;"><font class="tn-in-text"> Review </font></button></a>
                                       &nbsp;&nbsp;&nbsp;-->

...
<body>
            ...
            <table border="0" width="100%" style=" border-spacing: 0;margin:0;padding:0;margin-top:25px; ">
                <tr >
                    ...
                    <td>
                        ...
                        <form action="" method="post" class="header-search">
                            ...
                            <input type="search" name="search-box" class="input-text header-searchbar" placeholder="Search Patient (name/email)" list="patient">&nbsp;&nbsp;
                            ...
                            echo ' </datalist>';
                            ?>                        
                            <input type="Submit" value="Search (name/email)" name="search" class="login-btn btn-primary btn" style="padding-left: 25px;padding-right: 25px;padding-top: 10px;padding-bottom: 10px;">
                ...
                <tr>
                    <td colspan="4" style="padding-top:10px;">
                        <p class="heading-main12" style="margin-left: 45px;font-size:18px;color:rgb(49, 49, 49)"><?php echo "My Patients (".$list11->num_rows.")"; ?> </p>
                    </td>
                        ...
                        <tbody>
                            ...
                            <?php
                                ...
                                if($result->num_rows==0){
                                    ...
                                    <center>                                
                                    <br>
                                    <p class="heading-main12" style="margin-left: 65px;font-size:26px;color:rgb(49, 49, 49);">The system did not find the Search!</p>
                                    </center>
                                    <br><br><br><br>
                                    </td>
                                    </tr>';                                
    ...
    if($_GET){
        ...
        $id=$_GET["id"];
        $action=$_GET["action"];
            $sqlmain= "select * FROM ehos_patient WHERE patient_id='$id'";
            $result= $database->query($sqlmain);
            $row=$result->fetch_assoc();
            $name=$row["patient_name"];
            $email=$row["patient_email"];

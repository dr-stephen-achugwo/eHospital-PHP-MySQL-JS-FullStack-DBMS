...
<?php
    ...
    $sqlmain = "SELECT appointment.appointment_id,schedule.schedule_id,schedule.title,doctor.doctor_name,patient.patient_name,schedule.schedule_date,schedule.schedule_time,appointment.appointment_num,appointment.appointment_date 
        FROM ehos_schedule 
        INNER JOIN ehos_appointment on schedule.schedule_id = appointment.schedule_id 
        INNER JOIN ehos_patient on patient.patient_id = appointment.patient_id 
        INNER JOIN ehos_doctor on schedule.doctor_id = doctor.doctor_id 
        WHERE ehos_patient.patient_id=?";
            ...
            <table border="0" width="100%" style=" border-spacing: 0;margin:0;padding:0;margin-top:25px; ">
                ...
                <tr>
                    <td colspan="4" style="padding-top:10px;width: 100%;" >
                        ...
                        <p class="heading-main12" style="margin-left: 45px;font-size:18px;color:rgb(49, 49, 49)">My saved classes (<?php echo $result->num_rows; ?>)</p>
                    </td>
                                        ...
                                        for($q=0;$q<3;$q++){
                                            ...
                                            <td style="width: 25%;">
                                                    <div  class="dashboard-items search-items"  >
                                                        ...
                                                        <div style="width:100%;">
                                                        <div class="h3-search">
                                                                    Date of reservation: '.substr($appointment_date,0,30).'<br>
                                                                    Number: OC-000-'.$appointment_id.'
                                                                </div>
                                                                <div class="h1-search">
                                                                    '.substr($title,0,100).'<br>
                                                                </div>
                                                                <div class="h3-search">
                                                                    Number of reservation:<div class="h1-search">0'.$appointment_num.'</div>
                                                                </div>
                                                                <div class="h3-search">
                                                                    '.substr($doctor_name,0,100).'
                                                                </div>                                                                                                        
                                                                <div class="h4-search">
                                                                    Booked date: '.$schedule_date.'<br>Започва в: <b>'.substr($schedule_time,0,5).'</b>
                                                                </div>
                                                                <br>

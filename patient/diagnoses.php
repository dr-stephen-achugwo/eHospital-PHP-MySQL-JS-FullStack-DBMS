                ...
                <tr>
                   <td colspan="4">
                       <center>
                        ...
                        <tbody>
                                    <?php
                                    $query = "SELECT * FROM ehos_prescriptions WHERE patient_id = '$userid'";
                                    ...
                                    if ($result->num_rows > 0) {
                                        while ($row = $result->fetch_assoc()) {
                                            ...
                                            $medication_query = "SELECT * FROM ehos_medications WHERE medication_id = '$medication_id'";
                                            ...
                                            $diagnosis_query = "SELECT * FROM ehos_diagnoses WHERE diagnosis_id = '$diagnosis_id'";
                                            ...
                                            $doctor_query = "SELECT * FROM ehos_doctor WHERE doctor_id = '$doctor_id'";
                                        ...
                                        echo '<tr><td colspan="4" style="text-align: center; font-size: 18px; padding: 30px 20px 50px;";"> You have no current prescriptions.</td></tr>';
                                    }
                                 ?>
                            </tbody>
                        </table>

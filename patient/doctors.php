...
<body>
                ...
                <tr >
                    ...
                    <td>
                        ...
                        <form action="" method="post" class="header-search">
                            ...
                            echo ' </datalist>';
                            ?>                      
                            <input type="Submit" value="Search" class="login-btn btn-primary btn" style="padding-left: 21px;padding-right: 25px;padding-top: 10px;padding-bottom: 10px;">
                        ...
                        <tbody>
                            ...
                            <?php
                                ...
                                if($result->num_rows==0){
                                    ...
                                    <center>
                                    <br>
                                    <p class="heading-main12" style="margin-left: 25px;font-size:20px;color:rgb(49, 49, 49)">The system did not find your search!</p>
                                    </center>
                                    <br><br><br><br>
                                    </td>
                                    </tr>';
                                ...
                                for ( $x=0; $x<$result->num_rows;$x++){
                                    ...
                                    echo '<tr>
                                       ...
                                       &nbsp;&nbsp;&nbsp;
                                       <a href="?action=session&id='.$doctor_id.'&name='.$name.'"  class="non-style-link"><button  class="btn-primary-soft btn button-icon"  style="padding-left: 20px;padding-top: 12px;padding-bottom: 12px;margin-top: 10px;"><font class="tn-in-text">Sessions</font></button></a>
                                        </div>
                                        </td>
                                    </tr>';
    ...
    if($_GET){
        ...
        if($action=='view'){
            $sqlmain = "SELECT * FROM ehos_doctor WHERE doctor_id=?";
            $stmt = $database->prepare($sqlmain);
            ...
            $stmt = $database->prepare("SELECT specialty_name FROM ehos_specialties WHERE specialty_id=?");
            ...
            <div id="popup1" class="overlay">
                    <div class="popup">
                    <center>
                        <h2 style=font-size:30px>Referral to medical sessions</h2>
                        <a class="close" href="doctors.php">&times;</a>
                        <div class="content" style="font-size:22px">
                            Want to see all sessions from <br>'.substr($name,0,40).'?                            
                        </div>
